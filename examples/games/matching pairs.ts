...
namespace MatchingPairs {
    ...
    var flipFlag : boolean = false;

    var startList = new Array();
    var squareList = new Array();

    var masterCounter : number = 0;
    var squareCounter : number = 0;
    var square1Num;
    var square2Num;
    var savedSquareX1;
    var savedSquareY1;
    ...
    function countDownTimer() {
        ...
        var timeLimit : number = 120;
    
        var mySeconds : number = game.time.totalElapsedSeconds();
    ...
    function randomizeTiles() {
        ...
        for (var num : number = 1; num <= 18; num++)
        {
            startList.push(num);
        }
        ...
        // for debugging
        var myString1 : string = startList.toString();
        ...
        // for debugging
        var myString2 : string = squareList.toString();

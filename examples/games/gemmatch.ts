...
namespace GemMatch {
    ...
    function slideGem(pointer, x, y, fromClick) {
        ...
        {
            var cursorGemPosX : number = getGemPos(x);
            var cursorGemPosY : number = getGemPos(y);
    ...
    function getGemPos(coordinate: number) : number {
    ...
    function tweenGemPos(gem, newPosX, newPosY, durationMultiplier ?: number) {
